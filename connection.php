        ...
        <div class="modal">  <!-- toute la page / fenêtre -->
            ...
            <div class="modal__body">
                ...
                <div class="auth-form__header">
                    ...
                    <a class="auth-form__switch-btn-link" href="inscription.php" target="_blank">
                ...
                ?>
                <form class="auth-form__form" action="connection_traitement.php" method="POST" id="form-1">
                    <!-- Adresse Mail -->
                    <div class="auth-form__group">
                        <input for="email" id="email" name="email" type="email" class="auth-form__input auth-form__input2" placeholder="Adresse Mail">
                    ...
                    <div class="auth-form__aside">
                        <div class="auth-form__help">
                            <a href="mdpo.php" class="auth-form__help-link auth-form__help-link-forgot" target="_blank">Mot de passe oublié ?</a>
                            <span class="auth-form__help-separate"></span>
                            <a href="https://www.u-pec.fr/fr/contacts" class="auth-form__help-link" target="_blank">Besoin d'aide ?</a>
                        </div>
                    </div>

                    <!-- Button Retourner à la page d'accueil / Button Se connecter -->
                    <div class="auth-form__control">
                        <a href="connection_traitement.php" class="auth-form__control-link">
