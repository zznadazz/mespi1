...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="inscriptionv2.css">
        ...
        <div class="modal"> <!-- toute la page / fenêtre -->
            ...
            <div class="modal__body">
                ...
                <div class="auth-form__header">
                    ...
                    <a class="auth-form__switch-btn-link" href="connexion.php" target="_blank">
                        <button class="auth-form__switch-btn">J'ai déjà un compte</button>
                    </a>
                </div>
                    
                <!-- Nom / Prénom / Email / Mot de passe / Confirmation du mot de passe -->
                <form class="auth-form__form" action="inscription_traitement.php" method="POST" id="form-1">
                    <!-- Nom -->
                    <div class="auth-form__group">
                        <input for="nom" id="nom" name="nom" type="text" class="auth-form__input auth-form__input2" placeholder="Nom">
                        <span class="form-message"></span>
                    </div>

                    <!-- Prénom -->
                    <div class="auth-form__group">
                        <input for="prenom" id="prenom" name="prenom" type="text" class="auth-form__input auth-form__input2" placeholder="Prénom">
                        <span class="form-message"></span>
                    </div>

                    <!-- Email -->
                    <div class="auth-form__group">
                        <input for="email" id="email" name="email" type="email" class="auth-form__input auth-form__input2" placeholder="Adresse Email">
                        <span class="form-message"></span>
                    </div>

                    <!-- Mot de passe -->
                    <div class="auth-form__group">
                        <input for="pwd" id="pwd" name="pwd" type="password" class="auth-form__input auth-form__input2" placeholder="Mot de passe">
                        <span class="form-message"></span>
                    </div>

                    <!-- Confirmation du mot de passe -->
                    <div class="auth-form__group">
                        <input for="Cpwd" id="Cpwd" name="Cpwd" type="password" class="auth-form__input auth-form__input2" placeholder="Confirmation du mot de passe">
                        <span class="form-message"></span>
                    </div>
                    ...
                    <div class="auth-form__group">
                        <div class="auth-form__aside">
                            <div class="auth-form__policy-text">
                                <input type="checkbox" name="acceptation" class="auth-form__input2" >
                    ...
                    <div class="auth-form__control">
                        <!--<a href="mespi__html.html" class="auth-form__control-link">
                            <button class="btn btn--normal auth-form__control-back">Retourner à la page d'accueil</button>
                        </a>-->
                        <a href="inscription_traitement.php" class="auth-form__control-link">
                        ...
                        <div class="grid__column-2-4">
                            ...
                            <ul class="footer-list">
                                <li class="footer-item">
                                    <a href="" class="footer-item__link">À propos</a>
                                </li>
                                <li class="footer-item">
