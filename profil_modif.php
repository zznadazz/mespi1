...
<section class="header">
    ...
    <div class= " ">
    <h1 style="margin: 1.5em; width: 60%; text-decoration: underline ; font-size: xx-large; "> Mes données personnelles: </h1>
        <?php 
            if(isset($_GET['email'])) {
                $EML=$_GET['email'];
    ...
    <div class="esthetics" style=" width: 65%; padding: 3em; height: 20em; background-color: whitesmoke; border: 1px black; border-radius: 2.5%; border-style: double; margin: auto; " >
            <table action=profil_traitement.php method=POST style="width: 70%; margin: auto; align-items= center;">
                <tr>
                    ...
                    <td> <p style="margin-left: 25px"> <input for="nom" id="nom" name="nom" type="text" class="auth-form__input auth-form__input2" value=<?php echo $NOM ?>> </p></td>
                </tr>
                ...
                <tr>
                    ...
                    <td> <p style="margin-left: 25px"> <input for="prenom" id="prenom" name="prenom" type="text" class="auth-form__input auth-form__input2" value=<?php echo $PRE ?>> </p></td>
                </tr>
                ...
                <tr>
                    ...
                    <td> <p style="margin-left: 25px"> <input for="email" id="email" name="email" type="email" class="auth-form__input auth-form__input2" value=<?php echo $EML ?>> </p></td>
                </tr>
                ...
                <tr>
                    ...
                    <td> <p style="margin-left: 25px"> <input for="adresse" id="adresse" name="adresse" type="text" class="auth-form__input auth-form__input2" value=<?php echo $ADR ?>> </p></td>
                </tr>

                <tr>
                    <td style="height: 1.75em; background-color: #01579b;" > <b style=" background-color: #01579b; color: white; font-size: large; margin-left: 25px"> Téléphone : </b> </td>
                    <td> <p style="margin-left: 25px"> <input for="tel" id="tel" name="tel" type="text" class="auth-form__input auth-form__input2" value=<?php echo $TEL ?>> <p></td>
                </tr>
                

            </table>
         
        <a href="profil_traitement.php" class="auth-form__control-link">
            <button style="margin-left: 40em ; height:1.75em ; margin-top: 1.5em; margin-bottom: 2em; background-color: #01579b; color: white; border: none; border-radius: 2px; cursor: pointer; padding: 15px 15px; align-items: center" class="btn btn--primary" class="btn btn--primary">Valider</button>
        </a>
